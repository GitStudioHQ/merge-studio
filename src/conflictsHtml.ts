...
export const UNDO_HOLD_MS = 3000;
...
<head>
  ...
  <style>
    ...
    .done {
      ...
      color: var(--jb-ok);
      font-size: 12px;
      background: rgba(86, 160, 94, 0.08);
    }
    .done .note { color: var(--vscode-descriptionForeground); }
...
<body>
  <div class="dialog">
    ...
    <div class="done" id="done" hidden>
      ...
      <span class="note">Commit when ready — hold Undo on a file to revert it. This dialog closes itself.</span>
    </div>
